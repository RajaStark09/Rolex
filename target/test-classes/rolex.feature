Feature: Validating the Food Items

Scenario: Validate the restaurants
...
#And User selects and view the pantry or restaurant
#And User scroll and check the variety of food items
